    ...
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className='text4xl sm:text-7xl font-bold text-white'>I'm a Full Stack Developer</h2>
                <p className='text-gray-500 py-4 max-w-md'>I'm Software Engineer & self-learning technology Enthusiast, having good Knowledge of Data-structure, Object-Oriented Programming concepts, analytical & communication skill. As Software Developer having good understanding of Front-End & Back-End Technologies & applications with tools & projects developed.</p>
                <div>
